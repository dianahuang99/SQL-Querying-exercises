...
-- Join the two tables so that every column
-- and record appears,
...
-- last_name
-- and count of vehicles.The first_name should be ordered in ascending order.Your output should look like this:
/*
...
-- and display the average price for each of the cars as integers.Display the owners first_name,
-- last_name,
-- average price
-- and count of vehicles.The first_name should be ordered in descending order.Only display results with more than one vehicle
